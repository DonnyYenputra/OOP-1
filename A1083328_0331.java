...
public class A1083326_0331 {

    static Animals[] animalsArr = new Animals[6];
    ...
    public static void main(String[] args) throws Exception {
        ...
        animalsArr[0] = new Animals("BABI", 1.1, 52, 100);
        animalsArr[1] = new Animals("KUCING", 1.5, 99, 200);
        animalsArr[2] = new Human("KECOA", 1.9, 80, 150, Gender.MALE);
        animalsArr[3] = new Human("KUDA", 1.8, 78, 130, Gender.MALE);
        animalsArr[4] = new Human("ANJING", 1.7, 48, 120, Gender.FEMALE);
        animalsArr[5] = new SnowQueen("ULAR", 1.7, 50, 120, Gender.FEMALE, true);
...
class Animals {
    ...
    Animals(String name, double height, double weight, double speed) {
        this.name = name;
        this.height = height;
        this.weight = weight;
        this.speed = speed;
